...
public class AnimationButtonMUTA extends View {
    ...
    public AnimationButtonMUTA(Context context) {
        this(context, null);
    }

    public AnimationButtonMUTA(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AnimationButtonMUTA(Context context, AttributeSet attrs, int defStyleAttr) {
